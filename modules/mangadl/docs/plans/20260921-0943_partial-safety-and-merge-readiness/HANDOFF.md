...
destination-root layout and responsive activity/raw-log switching. The final
merge is approved. A current
four-URL/four-worker run completed 4/4 chapters without a retry; S7 remains
planned but was explicitly deferred to a follow-up branch.
