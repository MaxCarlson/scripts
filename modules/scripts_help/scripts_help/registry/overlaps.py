...
OVERLAP_NOTES: list[dict] = [
    ...
    },
    {
        ...
        "programs": [
            ...
            "modules/filter_prune",
        ],
        "note": (
            "replacer.py does find-and-replace using ripgrep; filter-prune "
            "does fd/rg-based filtered file operations. Overlapping in how they search "
