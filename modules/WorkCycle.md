## Combined Work Loop Documentation
...
The agent must repeat the following cycle until the primary goal defined in `plan.txt` (or similar file or files) is substantially complete or until explicitly instructed to stop.
...
### Additional Considerations for Module Changes and New Features

1.  **When changing modules on which many modules depend:**
    *   Identify all dependent modules.
    *   Run tests for all dependent modules prior to making any changes to establish a baseline for all dependents.
    *   Ensure the changes you made haven't broken any dependent modules, or their tests, or harmed their performance.
    *   ...

2.  **When creating or adding new features to a module:**
    *   Run tests prior to making any changes to establish a baseline.
    *   Update documentation to reflect the new feature.
    *   Write tests to cover the new feature and its interactions with existing features.
    *   ...
