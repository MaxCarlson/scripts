...
- [ ] **In-flight: Multi-video verification workflow**
  ...
  - [ ] Surface overlap provenance inline within the detail pane (detector, ratio, hint timestamp) so the operator can trust the auto-seek before launching players.
