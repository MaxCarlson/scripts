...
# repo root assumed one level up from tests/
ROOT = HERE.parent
UI_PATH = ROOT / "yt_ae_dl" / "yt_ae_dl" / "ui.py"
...
def test_header_and_workers_wired():
    ...
    assert ("overall1" in ui.dash.lines) and ("overall2" in ui.dash.lines)
